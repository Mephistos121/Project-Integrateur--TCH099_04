window.addEventListener("load", (event1) => {
    ...
    const tabModifierCinema = document.querySelector("#modifier_cinema");
      ...
      if (perms === "admin") {
        ...
        check
          ...
          :actionReussi("Veuillez entrer toutes les informations du compte");
      });
          ...
          ubutton.addEventListener("click", (event4) => {
              ...
              check ? updateFilm(info_film) : actionReussi("Veuillez entrer toutes les informations du film");
          });
          ...
          cinemaUpdate.addEventListener("click", (event6) => {
              ...
              check ? updateCinema(info_cinema) : actionReussi("Veuillez entrer toutes les informations du film");
          });
          fetchListeCinema();
  ...
  async function ajouterNouveauFilm(film) {
      ...
      if (check) {
          ...
          if (content.erreur) {
            ...
            actionReussi("Le film a été ajouté avec succès");
          }
      }
      else {
  ...
  async function updateFilm(film) {
    ...
    if (content.erreur) {
      ...
      actionReussi("Le film a été mis à jour avec succès");
    }
  }
  ...
  async function deleteFilm(film_id) {
    ...
    if (content.erreur) {
      ...
      actionReussi("Le film a été supprimé avec succès");
    }
  }
  ...
  async function updateCinema(cinema) {
    ...
    if (content.erreur) {
      ...
      actionReussi("Le cinéma a été mis à jour avec succès");
    }
  }
