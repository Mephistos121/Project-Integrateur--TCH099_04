  ...
  if (perms === "admin") {
    sbutton.addEventListener("click", (event3) => {
      const info_film = {
        ...
        genre_principal: document.querySelector("#update_genre_principal")
          .value,
        genre_secondaire: document.querySelector("#update_genre_secondaire")
          .value,
        ...
        acteur_principal: document.querySelector("#update_acteur_principal")
          .value,
        acteur_secondaire: document.querySelector("#update_acteur_secondaire")
          .value,
      };
    ...
    cinemaUpdate.addEventListener("click", (event6) => {
      const id_cinema = new URLSearchParams(window.location.search).get(
        "cinemaId"
      );
      const info_cinema = {
        id: id_cinema,
